import { z } from "zod";
import { generateContent, buildLearnerContext, LMS_SYSTEM_INSTRUCTION, } from "../services/gemini.js";
import { truncate } from "../services/formatting.js";
export function registerAITools(server) {
    // ── lms_ai_explain_concept ────────────────────────────────────────────────
    server.registerTool("lms_ai_explain_concept", {
...
Returns: AI-generated plain-English explanation of the concept.`,
    ...
    server.registerTool("lms_ai_lesson_summary", {
...
Keep it concise and student-friendly.`;
    ...
    server.registerTool("lms_ai_generate_quiz", {
...
Return ONLY valid JSON in this exact format (no markdown, no explanation):
{
  "quiz": [
    ...
    server.registerTool("lms_ai_revision_notes", {
...
Start directly with the content — no preamble.`;
    ...
    server.registerTool("lms_ai_interview_questions", {
...
Make questions progressively harder. Focus on practical application.`;
    ...
    server.registerTool("lms_ai_generate_roadmap", {
...
Keep it practical, opinionated, and actionable. Format in clear markdown.`;
    ...
    server.registerTool("lms_ai_practical_applications", {
